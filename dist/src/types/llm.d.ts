...
export type ContentAnalysisType = 'sentiment' | 'topics' | 'entities' | 'language' | 'toxicity' | 'spam' | 'categories' | 'keywords' | 'summary';
...
export type ProviderConfig = OpenAIConfig | AnthropicConfig | GoogleConfig | AzureConfig | HuggingFaceConfig | OllamaConfig | CohereConfig;
