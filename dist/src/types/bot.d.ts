...
export type CommandCategory = 'general' | 'admin' | 'moderation' | 'summary' | 'settings' | 'analytics' | 'help';
...
export type BotEventType = 'message_received' | 'command_executed' | 'user_joined' | 'user_left' | 'summary_generated' | 'error_occurred' | 'rate_limit_exceeded' | 'webhook_received' | 'scheduled_task_executed';
...
export type ErrorType = 'telegram_api' | 'database' | 'llm_api' | 'validation' | 'rate_limit' | 'permission' | 'internal' | 'network' | 'timeout';
...
export type TaskType = 'generate_summary' | 'cleanup_old_data' | 'send_notification' | 'update_statistics' | 'backup_data' | 'health_check';
